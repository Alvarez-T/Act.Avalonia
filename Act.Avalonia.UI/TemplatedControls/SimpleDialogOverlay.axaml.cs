...
public class SimpleDialogOverlay : DialogOverlay
{
    ...
    public static readonly StyledProperty<string?> TitleProperty = AvaloniaProperty.Register<SimpleDialogOverlay, string?>(
        nameof(Title));
    ...
    public static readonly StyledProperty<DialogButton> ButtonsProperty = AvaloniaProperty.Register<SimpleDialogOverlay, DialogButton>(
        nameof(Buttons));
    ...
    public static readonly StyledProperty<DialogMode> ModeProperty = AvaloniaProperty.Register<SimpleDialogOverlay, DialogMode>(
        nameof(Mode));
